...
// import social from '../assets/images/spaces/social.svg'
          ...
          <div className="mx-4 md:mx-auto container lg:flex lg:items-center lg:justify-between">
            <div className="min-w-0 flex-1">
              <div className="flex justify-center sm:justify-start">
                <img
                  className="rounded-lg w-auto h-16 mr-5 border border-gray-200 dark:border-gray-800"
                  ...
                  <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-8">
                    <div className="mt-2 flex items-center text-sm text-gray-600 dark:text-gray-400">
                      <div className="flex">
                        ...
                        <a
                          href="https://testimonial.to/kushal"
                          target="_blank"
                          className="underline break-words"
                        >
                          https://testimonial.to/kushal
                        </a>
                      </div>
                    </div>
                  </div>
...

{
  ...
  <button className="text-gray-400 rounded-full w-6 h-6" style={{position: "absolute", right: "5px" ,top: "5px" ,zIndex: "999", outline: "none"}} onClick={handleToggle} >
  
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path></svg></button>
  
  <section className="relative"><div className="w-full mx-auto px-4 sm:px-6 relative"><div className="py-6"><div className="w-full mx-auto text-center text-gray-800"><h3 className="h3 mb-4">Embed a Wall of Love</h3></div><div className="max-w-4xl mx-auto"><p className="text-base font-medium w-full text-gray-800 text-center mb-4"><span className="inline-flex items-center px-2.5 py-0.5 rounded-full font-medium bg-purple-100 text-purple-800 mr-2">Step 1</span>
...
<ul className="grid grid-cols-1 gap-6 sm:grid-cols-3"><li className="col-span-1 flex flex-col text-center bg-white rounded-lg border-gray-300 border  hover:shadow-lg divide-y divide-gray-200 cursor-pointer"><div className="flex-1 flex flex-col justify-between">
  
  
  
  
  <img className="w-full flex-shrink-0 border-none my-auto rounded-lg" src="https://firebasestorage.googleapis.com/v0/b/testimonialto.appspot.com/o/assets%2Fanimated-demo.gif?alt=media&amp;token=08b0e0d6-5290-4441-a309-942e074c7b77" alt="auto scrolling masonry grid"></img>
  
  
  
  <h3 className="my-3 text-gray-900 text-base font-semibold">Masonry - animated</h3></div></li><li className="col-span-1 flex flex-col text-center bg-white rounded-lg border-gray-300 border  hover:shadow-lg divide-y divide-gray-200 cursor-pointer"><div className="flex-1 flex flex-col justify-between">
    ...
    <h3 className="my-3 text-gray-900 text-base font-semibold">Masonry - fixed</h3></div></li><li className="col-span-1 flex flex-col text-center bg-white rounded-lg border-gray-300 border  hover:shadow-lg divide-y divide-gray-200 cursor-pointer"><div className="flex-1 flex flex-col justify-between">
    
    <img className="w-full flex-shrink-0 border-none my-auto rounded-lg" src="https://firebasestorage.googleapis.com/v0/b/testimonialto.appspot.com/o/assets%2Fcarousel-animated.gif?alt=media&amp;token=7a42bb1a-0b98-45e9-acbf-37f8a9f36a4e" alt="Fixed masonry grid"/><h3 className="my-3 text-gray-900 text-base font-semibold">Carousel slider</h3></div></li></ul></div><p className="text-base w-full text-gray-600 text-center mt-4">Check out our <a className="underline" href="https://help.testimonial.to/en/articles/6223121-embed-a-wall-of-love" target="_blank">Wall of Love embed guide</a> for more help.</p></div></div></section></div>
            ...
            <nav className="sm:w-full ml-auto mt-10">
              ...
              <div className="mt-8">
                ...
                <button className="w-full mt-1 group flex items-center px-3 py-2 text-base leading-5 font-medium text-gray-800 hover:text-gray-600 dark:text-white rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-gray-200 focus:outline-none transition ease-in-out duration-150" onClick={handleToggle}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
