...
function SpaceComponent({ data, onDelete }) {
  ...
  return (
    <li class="col-span-1 flex shadow-sm rounded-md border border-gray-200 dark:border-gray-600 hover:shadow-md">
      <img
        loading="lazy"
        class="bg-white object-contain inline-flex items-center justify-center w-20 h-20 rounded-l-md cursor-pointer "
        src={data.image}
      />
      <div class="flex-1 flex items-center justify-between  bg-white dark:bg-gray-800 dark:hover:bg-gray-700 rounded-r-md border-l border-gray-200 dark:border-gray-800 ">
        <div class="flex-1 p-4 cursor-pointer ">
          <div class="text-gray-600 dark:text-gray-100 test-md text-2xl hover:text-gray-800 dark:hover:text-white">
            {data.spaceName}
          </div>
        </div>
        <div class="flex-shrink-0 pr-2">
          <div class="relative flex justify-end items-center">
            <div class="relative inline-block text-left">
              <div>
                <button
                  class="group w-full flex items-center px-4 py-2 text-sm text-white hover:bg-red-500 hover:text-white"
