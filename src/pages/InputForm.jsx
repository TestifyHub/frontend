        ...
        <div className="flex flex-col min-h-screen overflow-y-scroll bg-gray-50">
          <div className="fixed z-40 inset-0 overflow-y-scroll">
            <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0 bg-dashboard">
              <div
                className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow shadow-xl sm:my-8 sm:align-top sm:max-w-6xl sm:w-full sm:p-6 z-50"
                              ...
                              <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
                                <div className="py-12">
                                  <div className="max-w-3xl mx-auto text-center pb-6">
                                    <div
                                      className="relative inline-flex flex-col justify-center mb-4"
                                    ...
                                    <div className="w-full px-4 py-4 text-left mx-auto">
                                      ...
                                      <ul className="mt-2 max-w-xl text-base list-disc pl-4 text-gray-500">
                                        ...
                                        <li>
                                          What is the best thing about [our
                                          product / service]
                                        </li>
                                        <li>
                                          How has [our product / service] helped
                                          you?
                                        </li>
                                      </ul>
                                    </div>
                        ...
                        <div class="w-full mx-auto px-4 sm:px-6 relative">
                          <div class="py-12">
                            <div class="flex text-sm">
                              <button
                                class="py-2 grow flex justify-center border-gray-200 text-gray-700 text-white bg-purple-600 font-bold border rounded-tl-md rounded-bl-md"
                                fdprocessedid="syvm"
                              >
                            ...
                            <div class="flex justify-center">
                              <div class="w-1/3 border-t bg-gray-50 my-5"></div>
                            </div>

                            <div class="w-full mx-auto text-center pb-12 text-gray-800">
                              <h3
                                class="h3 mb-4 aos-init aos-animate"
                                data-aos="fade-up"
                              >
                                Create a new Space
                              </h3>
                              <p
                                class="text-base w-full text-gray-600 aos-init aos-animate"
                                data-aos="fade-up"
                                data-aos-delay="200"
                              >
                            ...
                            <div class="max-w-xl mx-auto">
                              <div class="flex flex-wrap -mx-3 mb-4">
                                <div class="w-full px-3">
                                  ...
                                  <input
                                    id="name"
                                    type="text"
                                    class="form-input w-full text-gray-800 border-gray-300 rounded-md"
                                    placeholder=""
                                    required=""
                                    value=""
                                    fdprocessedid="u46lpb"
                                  />
                                  <span class="block text-gray-500 text-xs font-medium">
                              ...
                              <div class="flex flex-wrap -mx-3 mb-4">
                                <div class="w-full px-3">
                                  <label
                                    class="flex flex-row text-gray-700 text-sm font-medium mb-1"
                                    for="message"
                                  >
                                    Space logo
                                    <span class="text-red-600">*</span>
                                    <div class="relative flex rounded-md items-start my-auto ml-2">
                                      <div class="flex items-center h-5 my-auto">
                                        <input
                                          ...
                                          name="squareLogo"
                                          type="checkbox"
                                          class="focus:ring-purple-500 h-4 w-4 text-purple-600 rounded cursor-pointer"
                                          checked=""
                                        />
                                      </div>
                                  ...
                                  <div class="mt-2 flex items-center">
                                    ...
                                    <span class="ml-5 rounded-md shadow-sm">
                                      ...
                                      <label
                                        for="newLogoURL"
                                        class="py-2 px-3 border border-gray-300 rounded-md text-sm leading-4 font-medium text-gray-600 hover:text-gray-700 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800 transition duration-150 ease-in-out cursor-pointer"
                                      >
                                        Change
                                      </label>
                                    </span>
                              ...
                              <div class="flex flex-wrap -mx-3 mb-4">
                                <div class="w-full px-3">
                                  ...
                                  <textarea
                                    ...
                                    class="flex-1 form-input block w-full min-w-0 rounded-md text-gray-800  transition duration-150 ease-in-out sm:text-sm sm:leading-5 border-gray-300"
                                  ></textarea>
                                  <span class="block text-gray-500 text-xs font-medium">
                                    Markdown supported
                                  </span>
                              ...
                              <div class="flex flex-wrap -mx-3 mb-4">
                                <div class="w-full px-3">
                                  ...
                                  >
                                    Questions
                                    <svg
                                      class="ml-2 my-auto flex-shrink-0 h-4 w-4 text-gray-500 cursor-pointer"
                                      xmlns="http://www.w3.org/2000/svg"
                                      fill="none"
                                      viewBox="0 0 24 24"
                                      stroke="currentColor"
                                      data-tip="true"
                                      data-for="question-label"
                                      currentItem="false"
                                    >
                                      <path
                                        stroke-linecap="round"
                                      ...
                                      >
                                        <div class="flex flex-row">
                                          ...
                                          >
                                            <svg
                                              xmlns="http://www.w3.org/2000/svg"
                                              class="h-6 w-6 text-gray-600 hover:text-gray-400"
                                              fill="none"
                                              viewBox="0 0 24 24"
                                              stroke="currentColor"
                                            >
                                          ...
                                          <div class="w-full mt-1 relative">
                                            <input
                                              ...
                                              class="shadow-sm focus:ring-purple-500 focus:border-purple-500 block w-full sm:text-sm border-gray-300 rounded-md text-gray-700 pr-20"
                                              maxlength="100"
                                              value="Who are you / what are you working on?"
                                              fdprocessedid="qwuklb"
                                            />
                                          ...
                                          <div class="my-auto">
                                            <svg
                                              xmlns="http://www.w3.org/2000/svg"
                                              class="h-5 w-5 text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-200 cursor-pointer ml-2"
                                              fill="none"
                                              viewBox="0 0 24 24"
                                              stroke="currentColor"
                                            >
                              ...
                              <button
                                type="button"
                                class="mt-2 flex flex-row items-center p-1 pl-0 border border-transparent rounded-full text-gray-800 text-sm"
                                fdprocessedid="n0kamg"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  fill="none"
                          ...
                          <div class="flex flex-wrap -mx-3 mb-4">
                            <div class="w-full px-3">
                              <label
                                class="flex flex-row text-gray-700 text-sm font-medium mb-2"
                                for="header"
                              >
                                Custom button color
                                <div>
                                  <div
                                    class="__react_component_tooltip t70210919-6147-4e23-8729-9dab29d072b0 place-top type-dark"
                                    id="btn-color-tip"
                                    data-id="tooltip"
                                    style={{ left: "650px", top: "468px" }}
                                  ></div>
                                </div>
                              </label>
                              <div>
